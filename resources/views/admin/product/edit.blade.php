                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <select class="form-control" name="subcategory_id" id="subcategory_id">
                        ...
                        @foreach($category as $row)
                           ...
                           @endphp
                           <option style="color:blue;" disabled="">{{ $row->Catagory_name }}</option>
                              @foreach($subcategory as $row)
                                <option value="{{ $row->id }}" @if($row->id==$product->subcategory_id) selected @endif > -- {{ $row->Subcatagory_name }}</option>
                              @endforeach
                        @endforeach 
                      </select>
                    </div>
                    ...
                    <div class="form-group col-lg-6">
                      ...
                      <select class="form-control" name="warehouse">
                        @foreach($warehouse as $row)
                         <option value="{{ $row->id }}">{{ $row->ware_name }}</option>
                        @endforeach 
                      </select>
                    </div>
                    <div class="form-group col-lg-6">
