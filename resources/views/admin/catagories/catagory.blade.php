      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="Catagory_name" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter a Name" required>
                ...
                <div class="form-group">
                  ...
                  <input class="dropify" type="file" name="icon" accept="image/*">
        ...
        <div class="modal-body">
          ...
          <input type="hidden" id="e_icon"name="old_icon">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="Catagory_name" id="e_catagory_name" 
                ...
                <div class="form-group">
                  ...
                  <input class="dropify" name="icon" type="file" accept="image/*">
                  <small id="emailHelp" class="form-text text-muted">Enter a Icon.</small>
                </div>
