    ...
    <div class="banner">
        ...
        <div class="container fill_height">
            <div class="row fill_height">
                <div class="banner_product_image"><img src="{{ asset('file/product/'.$bannerproduct->thumbnail) }}" alt="{{ $bannerproduct->name }}"></div>
                            ...
                            <div class="owl-carousel owl-theme deals_slider">
                               ...
                               @foreach($todaydeal as $row)    
                                ...
                                <div class="owl-item deals_item">
                                    <div class="deals_image"><img src="{{ asset('file/product/'.$row->thumbnail) }}" alt="{{ $row->name }}"></div>
                                    ...
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset('file/product/'.$row->thumbnail) }}" alt="{{ $row->name }}" height="100%" width="60%">
                                            </div>
                            ...
                            <div class="owl-item">
                                <div class="popular_category d-flex flex-column align-items-center justify-content-center">
                                    <div class="popular_category_image">
                                        <img src="{{ asset($row->icon) }}" alt="{{ $row->Catagory_name }}"></div>
                                    <div class="popular_category_text">
                                      <a href="{{ route('categorywise.product',$row->id) }}">  {{ $row->Catagory_name }} </a>
                                    </div>
                                </div>
                            </div>
                           @endforeach 
                ...
                <div class="col">
                    <div class="tabbed_container">
                        <div class="tabs clearfix tabs-right">
                            <div class="new_arrivals_title">{{ $row->Catagory_name }}</div>
                            <ul class="clearfix">
                            ...
                            <div class="col-lg-12" style="z-index:1;">
                                ...
                                <div class="product_panel panel active">
                                    <div class="arrivals_slider slider">
                                       ...
                                       @foreach($cat_product as $row1) 
                                        <!-- Slider Item -->
                                        <div class="arrivals_slider_item">
                                            <div class="border_active"></div>
                                            <div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
                                                <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('file/product/'.$row1->thumbnail) }}" alt="{{ $row1->name }}" height="100%" width="55%"></div>
                                                <div class="product_content">
                                                    @if($row1->discount_price==NULL)
                                                      <div class="product_price discount">{{ $setting->currency }}{{ $row1->selling_price }}</div>
                                                    @else
                                                      <div class="product_price discount">{{ $setting->currency }} {{ $row1->discount_price }}<span>{{ $setting->currency }} {{ $row1->selling_price }}</span></div>
                                                    @endif
                                                    
                                                    <div class="product_name"><div><a href="{{ route('product.details',$row1->slug) }}">{{ $row1->name }}</a></div></div>
                                                    <div class="product_extras">
                                                        <div class="product_color">
                                                            <a href="" class="quick_view" id="{{ $row1->id }}" data-toggle="modal" data-target="#exampleModalCenter">quick view</a>
                                                        </div>
                                                        <button class="product_cart_button quick_view"  id="{{ $row1->id }}" data-toggle="modal" data-target="#exampleModalCenter">Add to Cart</button>
                                                    </div>
                                                </div>
                                                <a href="{{ route('add.wishlist',$row1->id) }}">
                                                   <div class="product_fav">
                                                      <i class="fas fa-heart"></i>
                                                   </div>
                                                </a>
                         ...
                         @foreach($trendy_product as $row)
							<div class="owl-item">
								<div class="trends_item is_new">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('file/product/'.$row->thumbnail) }}" alt=""></div>
									<div class="trends_content">
										<div class="trends_category"><a href="#">Smartphones</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="product.html">{{ $row->category->Catagory_name }}</a></div>
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    <div class="trends_image d-flex flex-column align-items-center justify-content-center">
                                        <img src="{{ asset('file/product/'.$row->thumbnail) }}" alt="">
                                    </div>
                                    <div class="trends_content">
                                        ...
                                        @endif
                                          ...
                                          <div class="trends_info clearfix">
                                              <div class="trends_name">
                                                <a href="{{ route('product.details',$row->slug) }}">{{ substr($row->name,0,10) }}..</a>
                                              </div>
                                           </div>   
                                        </div>
                        ...
                        <div class="owl-carousel owl-theme reviews_slider">
                            ...
                            <div class="owl-item">
                                <div class="review d-flex flex-row align-items-start justify-content-start">
                                    <div><div class="review_image"><img src="{{ asset('file/dummy.jpg') }}" alt=""></div></div>
                           ...
                           @foreach($random_product as $row) 
                            ...
                            <div class="owl-item">
                                <div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                    <div class="viewed_image"><img src="{{ asset('file/product/'.$row->thumbnail) }}" alt="{{ $row->name }}"></div>
...
{{-- <script>
    $('body').on('click','.quick_view',function(){
      ...
      // alert(cat_id);
      $.get("product-quick-view/"+id,function(data){
