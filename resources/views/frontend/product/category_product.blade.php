...
@include('layouts.front_partial.collaps_nav')
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{ $category->Catagory_name }}</h2>
		</div>
	</div>
<!-- Shop -->
		<div class="brands">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								@foreach($subcategory as $row)
								 <li><a href="{{ route('subcategorywise.product',$row->id) }}">{{ $row->Subcatagory_name }}</a></li>
								@endforeach
							</ul>
						</div>
				...
				<div class="col-lg-9">
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span class="mr-2">{{ count($products) }}</span>    products found</div>
