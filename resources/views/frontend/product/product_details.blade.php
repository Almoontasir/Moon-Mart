		...
		<div class="row">
			...
			<div class="col-lg-1 order-lg-1 order-2" >
				...
				@isset($images)	
					...
					<li data-image="{{ asset('file/product/'.$image) }}">
						<img src="{{ asset('file/product/'.$image) }}" alt="nothing">
					</li>
					@endforeach
				@endisset	
				</ul>
			...
			<div class="col-lg-4 order-lg-2 order-1">
				...
				<div class="image_selected"><img src="{{ asset('file/product/'.$product->thumbnail) }}" alt=""></div>
			</div>
			...
			<div class="col-lg-4 order-3">
				...
				<div class="product_description">
					<div class="product_category">{{ $product->category->Catagory_name }} > {{ $product->subcategory->Subcatagory_name }}</div>
