...
@include('layouts.front_partial.collaps_nav')
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">{{ $subcategory->Subcatagory_name }}</h2>
		</div>
	</div>
<!-- Shop -->
		<div class="brands">
						...
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								@foreach($childcategories as $row)
								 <li><a href="{{ route('childcategorywise.product',$row->id) }}">{{ $row->Childcatagory_name }}</a></li>
								@endforeach
							</ul>
						</div>
						...
						<div class="product_grid row">
							...
							@foreach($products as $row)
								<div class="product_item is_new col-lg-2">
									...
									<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ asset('file/product/'.$row->thumbnail) }}" alt=""></div>
