                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo" ><a style="white-space: nowrap;
                                overflow: hidden;" href="{{ url('/') }}">Moon Mart</a></div>
                        </div>
                    </div>
                    ...
                    <div class="footer_column footer_contact">
                        ...
                        <div class="footer_social">
                            <ul>
                                ...
                                <li><a href="{{ $setting->instragram }}" target="_blank"><i class="fab fa-instagram"></i></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
